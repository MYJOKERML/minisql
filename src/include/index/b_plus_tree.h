...
class BPlusTree {
 ...
 private:
  ...
  bool CoalesceOrRedistribute(BPlusTreeLeafPage *&node, Transaction *transaction = nullptr);

  bool CoalesceOrRedistribute(BPlusTreeInternalPage *&node, Transaction *transaction = nullptr);
